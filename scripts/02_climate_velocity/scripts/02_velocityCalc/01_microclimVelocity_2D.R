...
past = list.files(path = 'data/microclim_3D/mosaics/', pattern = 'past', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/', pattern = 'pres', full.names = T)
...
# bio6 temp
past = list.files(path = 'data/microclim_3D/mosaics_temp_bio6/past', pattern = 'past', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics_temp_bio6/pres', pattern = 'pres', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
