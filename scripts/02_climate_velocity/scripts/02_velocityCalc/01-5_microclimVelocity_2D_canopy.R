...
source('scripts/00_functions/spatgrad_micro2D.R')
source('scripts/00_functions/spatgrad.R')
source('scripts/00_functions/tempGrad2.R')
source('scripts/00_functions/gVoCC_micro2D.R')
...
past = rast('data/microclim_3D/mosaics_relhgt/meanTmax/tmax_relhgt_past.tif')
pres = rast('data/microclim_3D/microclimate_models_update/mosaics_relhgt/meanTmax/tmax_relhgt_pres.tif')
...
# bio6 temp
past = rast('data/microclim_3D/microclimate_models_update/mosaics_relhgt/temp_bio6/temp_bio6_past.tif')
pres = rast('data/microclim_3D/microclimate_models_update/mosaics_relhgt/temp_bio6/temp_bio6_pres.tif')
#heights = c(2,5,10,15,20,25,30,35,40)
