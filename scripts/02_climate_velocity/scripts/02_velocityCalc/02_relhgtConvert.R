...
tmax = rast(list.files(path = 'output/3D/avg_daily_maxTemp', pattern = "vocc_..m.tif", full.names=T))
...
tmax_tempGrad = rast(list.files(path = 'output/3D/avg_daily_maxTemp', pattern = "temporalGradient_..m.tif", full.names = T))
