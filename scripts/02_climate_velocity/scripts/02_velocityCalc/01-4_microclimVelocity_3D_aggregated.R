...
past = list.files(path = 'data/microclim_3D/mosaics/mosaics_meanTmax/aggregated_100m/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_meanTmax/aggregated_100m/pres/', pattern = '.*pres_.*.tif', full.names = T)
...
past = list.files(path = 'data/microclim_3D/mosaics/mosaics_meanTmax/aggregated_1km/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_meanTmax/aggregated_1km/pres/', pattern = '.*pres_.*.tif', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
...
past = list.files(path = 'data/microclim_3D/mosaics/mosaics_temp_bio6/aggregated_100m/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_temp_bio6/aggregated_100m/pres/', pattern = '.*pres_.*.tif', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
...
past = list.files(path = 'data/microclim_3D/mosaics/mosaics_temp_bio6/aggregated_1km/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_temp_bio6/aggregated_1km/pres/', pattern = '.*pres_.*.tif', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
...
# TMAX (BIO5) AGGREGATED 100 M ---------------------------------------------------

past = list.files(path = 'data/microclim_3D/mosaics/mosaics_temp_bio5/aggregated_100m/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_temp_bio5/aggregated_100m/pres/', pattern = '.*pres_.*.tif', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
...
foreach (i=c(1:length(past)), .packages=c('terra', 'data.table', 'numform')) %dopar% {
  if (i <= length(past)-2) {
    ...
    fname_sp = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_100m/spatialGradient_', mid, 'm.tif')
    fname_tg = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_100m/temporalGradient_', mid, 'm.tif')
    fname_rast = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_100m/vocc_', mid, 'm.tif')
    fname_csv = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_100m/vocc_', mid, 'm.csv')
...
past = list.files(path = 'data/microclim_3D/mosaics/mosaics_temp_bio5/aggregated_1km/past/', pattern = '.*past_.*.tif', full.names = T)
pres = list.files(pat = 'data/microclim_3D/mosaics/mosaics_temp_bio5/aggregated_1km/pres/', pattern = '.*pres_.*.tif', full.names = T)
heights = c(2,5,10,15,20,25,30,35,40)
...
foreach (i=c(1:length(past)), .packages=c('terra', 'data.table', 'numform')) %do% {
  if (i <= length(past)-2) {
    ...
    fname_sp = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_1km/spatialGradient_', mid, 'm.tif')
    fname_tg = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_1km/temporalGradient_', mid, 'm.tif')
    fname_rast = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_1km/vocc_', mid, 'm.tif')
    fname_csv = paste0('scripts/02_climate_velocity/output/3D/temp_bio5/aggregated_1km/vocc_', mid, 'm.csv')
