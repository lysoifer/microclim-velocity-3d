...
for(i in 1:length(eramin)) {
  ...
  eraminlist.summ[[i]] = min(r.monthlymean) # annual mean of daily means
}
...
writeRaster(chel1960.tasmin, filename = "data/chelsa/tasmin1960_bio6estimate.tif")
...
#make blank rasters to store hourly values
eraTmin1980 = rast(eraGrid1980.crop, vals = 0)
eraTmin1960 = rast(eraGrid1960.crop, vals = 0)
